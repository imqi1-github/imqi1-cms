...
const cspContent = `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' ${siteConfig.cdnUrl} https://webapi.amap.com https://mapplugin.amap.com; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' ${siteConfig.cdnUrl}; img-src 'self' data: https: blob: ${siteConfig.cdnUrl}; font-src 'self' data: ${siteConfig.cdnUrl}; manifest-src 'self' ${siteConfig.cdnUrl}; media-src 'self' https: data: blob:; connect-src 'self' ${siteConfig.cdnUrl} https://api.github.com https://gitee.com blob:; object-src 'none'; base-uri 'self'; form-action 'self';`;
