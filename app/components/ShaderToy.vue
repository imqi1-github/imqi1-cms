// ✅ Inspira UI 官方 ShaderToy 组件
// 来源: https://github.com/unovue/inspira-ui/blob/master/components/content/inspira/ui/shader-toy/ShaderToy.vue
// 用 OGL 封装的 WebGL2 渲染器执行 GLSL 片段着色器，铺满容器
<template>
  <div
    ref="containerRef"
