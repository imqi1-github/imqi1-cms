// ✅ Inspira UI 官方 ShaderToy 运行时
// 来源: https://github.com/unovue/inspira-ui/blob/master/components/content/inspira/ui/shader-toy/InspiraShaderToy.ts
// 基于 OGL 的 WebGL2 渲染器，提供完整 Shadertoy uniform 体系（iResolution/iTime/iFrame/iMouse/iDate 等）
...
export class InspiraShaderToy {
  ...
  private _mouseSensitivity: number = 1.0; // mouse sensitivity multiplier
  private _mouseDamping: number = 0.9; // mouse movement damping factor (0-1)
