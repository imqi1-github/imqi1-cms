...
function registerClipboard (element, copyInfo) {
	Prism.instance.bindEvent(element, 'click', () => {
...
function getSettings (startElement) {
	/** @type {Settings} */
	const settings = {
		'copy': '<i class="ri-clipboard-fill"></i>',
		'copy-error': '<i style=\'color: red\' class=\"ri-close-line\"></i> 请使用 Ctrl + C 复制',
		'copy-success': '<i class="ri-check-fill"></i> 已复制!',
		'copy-timeout': 3000,
	};
